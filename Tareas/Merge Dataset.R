...
# convirtiendo salario por hora 0 en missing
enaho05$sal_hora_depend <- ifelse(enaho05$sal_hora_depend == 0, 
                                  NA, 
                                  ifelse(enaho05$sal_hora_depend > 0, 
